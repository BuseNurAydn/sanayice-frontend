...
const SubModal = ({title,subFormData,onChange,onSave,onClose,mainImageFile,setMainImageFile}) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-opacity-40">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
        ...
        {(mainImageFile || subFormData.imageUrl) && (
          <div className="relative mb-4 inline-block">
            <img
              src={mainImageFile ? URL.createObjectURL(mainImageFile) : subFormData.imageUrl}
              alt="Ana Resim"
        ...
        <div className="flex justify-end space-x-2">
          ...
          <button
            onClick={onSave}
            className="bg-[var(--color-orange)] hover:bg-[var(--color-dark-orange)] text-white px-4 py-2 rounded cursor-pointer"
          >
            Kaydet
          </button>
        </div>
