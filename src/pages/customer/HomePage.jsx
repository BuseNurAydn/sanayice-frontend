...
const HomePage = () => {
    ...
    const [loading, setLoading] = useState(false); // Ana kategori/ürün yüklemesi
    ...
    const [bannersLoading, setBannersLoading] = useState(true); // Banner yüklemesi için ayrı state
    ...
    const leftSettings = {
        ...
        responsive: [
            {
                breakpoint: 1024,
                settings: { slidesToShow: 1, slidesToScroll: 1, infinite: banners.length > 1, dots: false, },
            },
            {
                breakpoint: 600,
                settings: { slidesToShow: 1, slidesToScroll: 1, arrows: true, infinite: banners.length > 1, },
            },
        ],
    };
        ...
        <div className="bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto py-8 px-4">
                <section className="flex flex-col md:flex-row gap-6 pb-8">
                    {/* Sol Slider / Banner Alanı */}
                    <div className="relative w-full md:w-[820px]">
                        {bannersLoading || banners.length === 0 ? (
                            // Banner Yükleme İskeleti
                            <div className="flex items-center justify-center w-full h-[340px] bg-gray-200 rounded-md shadow-md animate-pulse">
                ...
                <section className="mb-12">
                    ...
                    <ScrollSection scrollRef={featuredScrollRef}>
                        {featuredProducts.length > 0 ? (
                            ...
                            // Öne çıkan ürünler yüklenmiyorsa iskelet göster
                            Array(5).fill(0).map((_, index) => (
                                <div key={index} className="flex-shrink-0 min-w-[224px] max-h-[330px]">
                                    <ProductCardSkeleton />
                                </div>
                            ))
                        )}
                ...
                <section className="mb-12">
                    ...
                    <ScrollSection scrollRef={discountedScrollRef}>
                        {discountedProducts.length > 0 ? (
                            ...
                            // İndirimli ürünler yüklenmiyorsa iskelet göster
                            Array(5).fill(0).map((_, index) => (
                                <div key={index} className="flex-shrink-0 min-w-[224px] max-h-[330px]">
                                    <ProductCardSkeleton />
                                </div>
                ...
                <section className="mb-12">
                    ...
                    <ScrollSection scrollRef={newProductsScrollRef}>
                        {newProducts.length > 0 ? (
                            ...
                            // Yeni ürünler yüklenmiyorsa iskelet göster
                            Array(5).fill(0).map((_, index) => (
                                <div key={index} className="flex-shrink-0 min-w-[224px] max-h-[330px]">
                                    <ProductCardSkeleton />
                                </div>
                ...
                {categories.length > 0 ? (
                    ...
                    // Kategoriler yüklenmiyorsa iskelet göster
